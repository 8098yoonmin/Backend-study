...
public class UserService {
    ...
    public UserService(UserRepository userRepository, PropertiesConfig propertiesConfig) {
    ...
    public void register(UserRegisterRequest userRegisterRequest){
        ...
        if(userRepository.existById(userRegisterRequest.getId())) {
    ...
    public void modify(UserRegisterRequest userRegisterRequest){
        User user = userRepository.getUser(userRegisterRequest.getId());
