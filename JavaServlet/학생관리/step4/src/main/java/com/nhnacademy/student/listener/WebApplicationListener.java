...
public class WebApplicationListener  implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        //String path = context.getRealPath("/WEB-INF/classes/yoonmin.json");
        String path = context.getRealPath("/WEB-INF/classes/yoonmin");

        StudentRepository studentRepository = new JsonStudentRepository(path);
        for(int i=1; i<=10; i++){
            String id="student"+i;
            String name="아카데미"+i;
