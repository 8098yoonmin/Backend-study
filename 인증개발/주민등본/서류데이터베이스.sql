...
(
   household_serial_number           BIGINT   AUTO_INCREMENT   not null,
...
-- 3. resident 테이블 데이터 추가 (rest api 이용)
-- insert into resident values(1,'user1','1234', '남길동', '130914-1234561', '남', '19130914072200', '자택', '경기도 성남시 분당구 대왕판교로645번길', '20210429090300', '주택', '강원도 고성군 금강산로 290번길');
-- insert into resident values(2,'user2','1234', '남석환', '540514-1234562', '남', '19540514173000', '병원', '경기도 성남시 분당구 대왕판교로645번길', null, null, null);
-- insert into resident values(3,'user3','1234', '박한나', '551022-1234563', '여', '19551022111500', '병원', '서울특별시 중구 세종대로 110번길', null, null, null);
-- insert into resident values(4,'user4','1234', '남기준', '790510-1234564', '남', '19790510204500', '병원', '경기도 성남시 분당구 대왕판교로645번길', null, null, null);
-- insert into resident values(5,'user5','1234', '이주은', '820821-1234565', '여', '19820821012800', '병원', '경기도 수원시 팔달구 효원로 1번길', null, null, null);
-- insert into resident values(6,'user6','1234', '이선미', '851205-1234566', '여', '19851205220100', '병원', '경기도 수원시 팔달구 효원로 1번길', null, null, null);
-- insert into resident values(7,'user7','1234', '남기석', '120315-1234567', '남', '20120315145900', '병원', '경기도 성남시 분당구 대왕판교로645번길', null, null, null);
--      
-- commit;
